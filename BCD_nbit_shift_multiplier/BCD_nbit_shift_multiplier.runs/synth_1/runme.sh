...
HD_PWD='D:/VIVADO/BCD_nbit_shift_multiplier/BCD_nbit_shift_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_nbit_shift_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_nbit_shift_multiplier.tcl
