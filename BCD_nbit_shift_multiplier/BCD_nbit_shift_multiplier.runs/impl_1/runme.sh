...
HD_PWD='D:/VIVADO/BCD_nbit_shift_multiplier/BCD_nbit_shift_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_nbit_shift_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_nbit_shift_multiplier.tcl -notrace
