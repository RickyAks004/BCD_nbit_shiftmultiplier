...
REM
REM Generated by Vivado on Sat Oct 25 18:24:28 +0530 2025
...
echo "xvlog --incr --relax -prj BCD_nbit_shift_multiplier_vlog.prj"
call xvlog  --incr --relax -prj BCD_nbit_shift_multiplier_vlog.prj -log xvlog.log
